...
import com.corebanking.ledger.consumer.TransferEventConsumer;
...
public class RedisStreamConfig {
    ...
    private static final String CONSUMER_NAME = "ledger-consumer-1";
    ...
    @Bean
    public Subscription transferEventSubscription(RedisConnectionFactory connectionFactory,

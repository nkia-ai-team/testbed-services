package com.fooddelivery.notify.config;

import com.fooddelivery.notify.consumer.OrderEventConsumer;
...
public class RedisStreamConfig {
    ...
    private static final String CONSUMER_NAME = "notify-consumer-1";

...
class RegistryContractTests(unittest.TestCase):
    ...
    def test_registry_closure_covers_64_scenarios_and_20_profiles(self) -> None:
        self.assertEqual(len(self.catalog["scenarios"]), 50)
    ...
    def test_all_64_scenarios_compile_with_trusted_live_plans(self) -> None:
        live_ids = {
            ...
            "F01-P", "F08-G", "F15-G", "F06-H", "F03-P", "F09-H", "F05-P", "F15-T1", "F17-R", "F18-P", "F19-P", "F19-S", "F16-H", "F20-R", "F20-P", "F20-Q", "F15-R", "F03-H",
        }
        for scenario in self.catalog["scenarios"]:

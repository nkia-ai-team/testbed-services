...
⚠ **주입 강도가 왜 11배 뛰었는지는 미조사.** 후보: 오늘 배포(39커밋) / commerce orders 1,185,713행 증가 /
`clean-window: false`이고 `overlapping_run_ids`에 F15-R·F15-T2·F23-R.
**강도가 이렇게 흔들리면 임계 보정 자체가 불안정하다** — 별도 항목.
